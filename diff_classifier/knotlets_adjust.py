...
def split(prefix, download_folder, download_bucket, upload_folder, upload_bucket
    ...
    remote_name = download_folder+'/'+filename
    local_name = local_folder+'/'+filename
    msd_file = 'msd_{}.csv'.format(prefix)
    ft_file = 'features_{}.csv'.format(prefix)
    aws.download_s3(remote_name, local_name, bucket_name=download_bucket)
    ...
    for name in names:
        aws.upload_s3(name, upload_folder+'/'+name, bucket_name=upload_bucket)
        os.remove(name)
